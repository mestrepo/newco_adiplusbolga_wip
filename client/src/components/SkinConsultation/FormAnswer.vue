<template>
    <div class="skinconsultation-form__answer">
    ...
    export default {
        ...
        computed: {
            showOKButton() {
                ...
                //TODO: remove above checks to allow OKay button to always show
                //TODO: alternatively remove every check except the email check to support Anonymous Authentication
                return true;
            },
